  ...
  while (true)
  {
    ...
    if (lasreader1->read_point())
    {
      if (lasreader2->read_point())
      {
        ...
        if (lasreader1->point.have_rgb || lasreader2->point.have_rgb)
        {
          if (lasreader1->point.have_nir || lasreader2->point.have_nir)
          {
            ...
            {
              if (different_points < shutup) fprintf(stderr, "RGBI of point %u of %u is different: (%d %d %d %d) != (%d %d %d %d)\n", (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.rgb[0], lasreader1->point.rgb[1], lasreader1->point.rgb[2], lasreader1->point.rgb[3], lasreader2->point.rgb[0], lasreader2->point.rgb[1], lasreader2->point.rgb[2], lasreader2->point.rgb[3]);
              difference = true;
            }
          }
          else
          {
            ...
            {
              if (different_points < shutup) fprintf(stderr, "RGB of point %u of %u is different: (%d %d %d) != (%d %d %d)\n", (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.rgb[0], lasreader1->point.rgb[1], lasreader1->point.rgb[2], lasreader2->point.rgb[0], lasreader2->point.rgb[1], lasreader2->point.rgb[2]);
              difference = true;
            }
          }
        }
        ...
        if (lasreader1->point.extra_bytes_number)
        {
          if (memcmp((const void*)lasreader1->point.extra_bytes, (const void*)lasreader2->point.extra_bytes, lasreader1->point.extra_bytes_number))
          {
            if (different_points < shutup)
            {
              ...
              {
                fprintf(stderr, "%d extra_byte of point %u of %u are different: %d != %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader2->point.extra_bytes[0]);
              }
              else if (lasreader1->point.extra_bytes_number == 2)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d != %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1]);
              }
              else if (lasreader1->point.extra_bytes_number == 3)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d != %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2]);
              }
              else if (lasreader1->point.extra_bytes_number == 4)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d != %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3]);
              }
              else if (lasreader1->point.extra_bytes_number == 5)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d != %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4]);
              }
              else if (lasreader1->point.extra_bytes_number == 6)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d != %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5]);
              }
              else if (lasreader1->point.extra_bytes_number == 7)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d != %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6]);
              }
              else if (lasreader1->point.extra_bytes_number == 8)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7]);
              }
              else if (lasreader1->point.extra_bytes_number == 9)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8]);
              }
              else if (lasreader1->point.extra_bytes_number == 10)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9]);
              }
              else if (lasreader1->point.extra_bytes_number == 11)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader1->point.extra_bytes[10], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9], lasreader2->point.extra_bytes[10]);
              }
              else if (lasreader1->point.extra_bytes_number == 12)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader1->point.extra_bytes[10], lasreader1->point.extra_bytes[11], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9], lasreader2->point.extra_bytes[10], lasreader2->point.extra_bytes[11]);
              }
              else if (lasreader1->point.extra_bytes_number == 13)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader1->point.extra_bytes[10], lasreader1->point.extra_bytes[11], lasreader1->point.extra_bytes[12], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9], lasreader2->point.extra_bytes[10], lasreader2->point.extra_bytes[11], lasreader2->point.extra_bytes[12]);
              }
              else if (lasreader1->point.extra_bytes_number == 14)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader1->point.extra_bytes[10], lasreader1->point.extra_bytes[11], lasreader1->point.extra_bytes[12], lasreader1->point.extra_bytes[13], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9], lasreader2->point.extra_bytes[10], lasreader2->point.extra_bytes[11], lasreader2->point.extra_bytes[12], lasreader2->point.extra_bytes[13]);
              }
              else if (lasreader1->point.extra_bytes_number == 15)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader1->point.extra_bytes[10], lasreader1->point.extra_bytes[11], lasreader1->point.extra_bytes[12], lasreader1->point.extra_bytes[13], lasreader1->point.extra_bytes[14], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9], lasreader2->point.extra_bytes[10], lasreader2->point.extra_bytes[11], lasreader2->point.extra_bytes[12], lasreader2->point.extra_bytes[13], lasreader2->point.extra_bytes[14]);
              }
              else if (lasreader1->point.extra_bytes_number == 16)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader1->point.extra_bytes[10], lasreader1->point.extra_bytes[11], lasreader1->point.extra_bytes[12], lasreader1->point.extra_bytes[13], lasreader1->point.extra_bytes[14], lasreader1->point.extra_bytes[15], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9], lasreader2->point.extra_bytes[10], lasreader2->point.extra_bytes[11], lasreader2->point.extra_bytes[12], lasreader2->point.extra_bytes[13], lasreader2->point.extra_bytes[14], lasreader2->point.extra_bytes[15]);
              }
              else if (lasreader1->point.extra_bytes_number == 17)
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d != %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader1->point.extra_bytes[10], lasreader1->point.extra_bytes[11], lasreader1->point.extra_bytes[12], lasreader1->point.extra_bytes[13], lasreader1->point.extra_bytes[14], lasreader1->point.extra_bytes[15], lasreader1->point.extra_bytes[16], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9], lasreader2->point.extra_bytes[10], lasreader2->point.extra_bytes[11], lasreader2->point.extra_bytes[12], lasreader2->point.extra_bytes[13], lasreader2->point.extra_bytes[14], lasreader2->point.extra_bytes[15], lasreader2->point.extra_bytes[16]);
              }
              else
              {
                fprintf(stderr, "%d extra_bytes of point %u of %u are different: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d ... != %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d ...\n", lasreader1->point.extra_bytes_number,  (U32)lasreader1->p_cnt, (U32)lasreader1->npoints, lasreader1->point.extra_bytes[0], lasreader1->point.extra_bytes[1], lasreader1->point.extra_bytes[2], lasreader1->point.extra_bytes[3], lasreader1->point.extra_bytes[4], lasreader1->point.extra_bytes[5], lasreader1->point.extra_bytes[6], lasreader1->point.extra_bytes[7], lasreader1->point.extra_bytes[8], lasreader1->point.extra_bytes[9], lasreader1->point.extra_bytes[10], lasreader1->point.extra_bytes[11], lasreader1->point.extra_bytes[12], lasreader1->point.extra_bytes[13], lasreader1->point.extra_bytes[14], lasreader1->point.extra_bytes[15], lasreader1->point.extra_bytes[16], lasreader2->point.extra_bytes[0], lasreader2->point.extra_bytes[1], lasreader2->point.extra_bytes[2], lasreader2->point.extra_bytes[3], lasreader2->point.extra_bytes[4], lasreader2->point.extra_bytes[5], lasreader2->point.extra_bytes[6], lasreader2->point.extra_bytes[7], lasreader2->point.extra_bytes[8], lasreader2->point.extra_bytes[9], lasreader2->point.extra_bytes[10], lasreader2->point.extra_bytes[11], lasreader2->point.extra_bytes[12], lasreader2->point.extra_bytes[13], lasreader2->point.extra_bytes[14], lasreader2->point.extra_bytes[15], lasreader2->point.extra_bytes[16]);
        ...
        if (lasreader1->point.extended_point_type || lasreader2->point.extended_point_type )
        {
          ...
          {
            if (different_points < shutup) fprintf(stderr, "  extended_scan_angle: %s %s (point index %u)\n", lasreader1->point.get_scan_angle_string().c_str(), lasreader2->point.get_scan_angle_string().c_str(), (U32)(lasreader1->p_cnt-1));
            difference = true;
          }
      ...
      else
      {
        ...
        fprintf(stderr, "%s (%u) has %u fewer points than %s (%u)\n", file_name2, (U32)lasreader2->p_cnt, (U32)(lasreader1->p_cnt - lasreader2->p_cnt), file_name1, (U32)lasreader1->p_cnt);
        break;
      }
    }
    else
    {
      if (lasreader2->read_point())
      {
        ...
        fprintf(stderr, "%s (%u) has %u more points than %s (%u)\n", file_name2, (U32)lasreader2->p_cnt, (U32)(lasreader2->p_cnt - lasreader1->p_cnt), file_name1, (U32)lasreader1->p_cnt);
        break;
      }
      else
      {
...
int main(int argc, char *argv[])
{
  ...
  if (wildcard1 && wildcard2)
  {
    ...
    while (lasreadopener1.active())
    {
      ...
      if (lasreader1->p_cnt == lasreader2->p_cnt)
      {
        LASMessage(LAS_INFO, "both have %lld points. took %g secs.", lasreader1->p_cnt, taketime()-start_time);
      }
      else
      {
        LASMessage(LAS_INFO, "one has %lld the other %lld points. took %g secs.", lasreader1->p_cnt, lasreader2->p_cnt, taketime()-start_time);
      }
      lasreader1->close();
      delete lasreader1;
      free(file_name1);
