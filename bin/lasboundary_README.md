...
Use the '-gdal' argument to export in other than the shp format. 
See [gdal_README.md] for details.
...
-gdal                 : Uses the GDAL library to support additional vector formats such as GML, GPKG, GeoJSON and GPX as poly output.  
                        Can also be used for SHP and KML. See [gdal_README.md] for details.  
