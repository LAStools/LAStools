...
lascanopy64 -i *.laz -ocsv -ground_class 3 -p_ith_return 2 -l_mom -pzabovex 4 -above_mean
...
-p_ith_return [n]        : percentage of i-th returns. Reports what percentage of all returns are specifically the n-th return.
-ground_class [c]        : percentage of returns classified as ground with classification [c]. Reports the proportion of points with the given classification code (e.g., c=2=ground).
