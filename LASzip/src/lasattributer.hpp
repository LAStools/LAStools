...
class LASLIB_DLL LASattribute {
 public:
  ...
  inline BOOL set_no_data(U8 no_data) {
    if (0 == get_type()) {
      this->no_data[0].u64 = no_data;
      options |= 0x01;
      return TRUE;
    }
    return FALSE;
  };
  inline BOOL set_no_data(I8 no_data) {
    if (1 == get_type()) {
      this->no_data[0].i64 = no_data;
      options |= 0x01;
      return TRUE;
    }
    return FALSE;
  };
  inline BOOL set_no_data(U16 no_data) {
    if (2 == get_type()) {
      this->no_data[0].u64 = no_data;
      options |= 0x01;
      return TRUE;
  ...
  inline BOOL set_no_data(I16 no_data) {
    if (3 == get_type()) {
      this->no_data[0].i64 = no_data;
      options |= 0x01;
      return TRUE;
  ...
  inline BOOL set_no_data(U32 no_data) {
    if (4 == get_type()) {
      this->no_data[0].u64 = no_data;
      options |= 0x01;
      return TRUE;
  ...
  inline BOOL set_no_data(I32 no_data) {
    if (5 == get_type()) {
      this->no_data[0].i64 = no_data;
      options |= 0x01;
      return TRUE;
  ...
  inline BOOL set_no_data(U64 no_data) {
    if (6 == get_type()) {
      this->no_data[0].u64 = no_data;
      options |= 0x01;
      return TRUE;
  ...
  inline BOOL set_no_data(I64 no_data) {
    if (7 == get_type()) {
      this->no_data[0].i64 = no_data;
      options |= 0x01;
      return TRUE;
  ...
  inline BOOL set_no_data(F32 no_data) {
    if (8 == get_type()) {
  ...
  inline void set_min(U8* min) {
    this->min[0] = cast(min);
    options |= 0x02;
  };
  inline void update_min(U8* min) {
    this->min[0] = smallest(cast(min), this->min[0]);
  };
  inline BOOL set_min(U8 min) {
    if (0 == get_type()) {
      this->min[0].u64 = min;
      options |= 0x02;
      return TRUE;
  ...
  inline void set_max(U8* max) {
    this->max[0] = cast(max);
    options |= 0x04;
  };
  inline void update_max(U8* max) {
    this->max[0] = biggest(cast(max), this->max[0]);
  };
  inline BOOL set_max(U8 max) {
    if (0 == get_type()) {
      this->max[0].u64 = max;
      options |= 0x04;
      return TRUE;
  ...
  inline BOOL set_scale(F64 scale) {
    if (data_type) {
      this->scale[0] = scale;
      options |= 0x08;
      return TRUE;
  ...
  inline BOOL set_offset(F64 offset) {
    if (data_type) {
