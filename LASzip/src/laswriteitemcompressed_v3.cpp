...
This was unfortunately released with an inefficiency (bug in context switching)
for points composed of more than one item and the scanner channel is populated.
===============================================================================
*/
...
This is mainly a copy & paste of LASreadItemCompressed_POINT14_v3 with a small
but important change to how the U32& contect is modified in the read() funtion.  
===============================================================================
*/
